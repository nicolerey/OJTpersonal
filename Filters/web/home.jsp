...
<%@page import="com.listener.AppEventsListener"%>
...
<html>
    ...
    <body>
        ...
        <center>
            ...
            <label>Counter: </label> <%=session.getAttribute("counter")%><br>
            <label>Session Counter: </label> <%=AppEventsListener.actvSession%>
        </center>
    </body>
</html>
